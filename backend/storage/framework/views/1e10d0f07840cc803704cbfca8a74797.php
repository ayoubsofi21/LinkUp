    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 gap-4">
            ...
            <div class="flex items-center flex-1 max-w-md gap-4">
                <!-- Logo -->
                <a href="<?php echo e(route('feed')); ?>" class="flex items-center gap-3 group">
                    <!-- Logo Icon Container -->
               <div
                    ...
                    <img
                        src="<?php echo e(asset('images/linkup-logo.png')); ?>"
                        alt="LinkUp Logo"
                ...
                <div class="relative" x-data="{ dropdown: false }">
                    <button
                        ...
                        <img
                            ...
                            src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&background=0D8ABC&color=fff"
...
</nav><?php /**PATH C:\Users\ENAA\Desktop\LinkUp\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>