    ...
    <aside class="lg:col-span-3 space-y-6 lg:sticky lg:top-24">
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md">
            ...
            <div class="px-6 pb-6 text-center relative">
                ...
                <div class="pt-12">
                    <h2 class="text-lg font-bold text-slate-900 tracking-tight"><?php echo e(auth()->user()->name); ?></h2>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm mb-6">
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex items-center gap-3 mb-4">
                    <img class="w-11 h-11 rounded-full object-cover" src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name)); ?>" alt="Avatar">
                    <div>
                        <h4 class="text-sm font-bold text-slate-900"><?php echo e(auth()->user()->name); ?></h4>
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <img
                                    ...
                                    alt="<?php echo e($post->description); ?>">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-sm mb-4">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center gap-3">
                                <img
                                    class="w-11 h-11 rounded-xl object-cover"
                                    src="https://i.pravatar.cc/150?u=<?php echo e($post->id); ?>"
                                    alt="<?php echo e($post->description); ?>">
                        ...
                        <div class="flex items-center justify-between pt-4 mt-4 border-t border-slate-100 text-xs font-semibold text-slate-500">
                            ...
                            <form action="<?php echo e(route('comments.create',$post->id)); ?>" method="post" class="flex gap-0 ">
                                <?php echo csrf_field(); ?>
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ENAA\Desktop\LinkUp\resources\views/pages/feed.blade.php ENDPATH**/ ?>