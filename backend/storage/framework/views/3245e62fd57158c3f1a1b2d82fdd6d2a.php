...
<div class="auth-layout">
    ...
    <aside class="hero-panel">
            ...
            <div class="mockup" style="position:relative;">
                ...
                <div class="mockup-body">
                    ...
                    <div style="display:flex;flex-direction:column;gap:10px;">
                        ...
                        <div class="mock-card">
                            <?php $__currentLoopData = [[70,'#2563EB',30],[55,'#4F46E5',45],[80,'#10B981',20]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:7px;">
                                <div style="height:6px;border-radius:3px;width:<?php echo e($r[0]); ?>%;background:#1e293b;"></div>
                                <div style="height:6px;border-radius:3px;width:<?php echo e($r[2]); ?>%;background:<?php echo e($r[1]); ?>;opacity:0.5;"></div>
                            </div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:8px;">
                        <?php $__currentLoopData = [['#2563EB','#4F46E5'],['#0EA5E9','#2563EB'],['#4F46E5','#8B5CF6']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mock-card">
                            <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
                                <div style="width:22px;height:22px;border-radius:50%;background:linear-gradient(135deg,<?php echo e($c[0]); ?>,<?php echo e($c[1]); ?>);flex-shrink:0;"></div>
                                <div>
        ...
        <div class="hero-stats">
            <?php $__currentLoopData = [['100K+','Developers'],['5K+','Projects'],['50K+','Daily Posts']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="hero-stat">
                <div class="hero-stat-dot"></div>
                <strong><?php echo e($s[0]); ?></strong> <?php echo e($s[1]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="auth-footer">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn-outline">
...
</html><?php /**PATH C:\Users\ENAA\Desktop\LinkUp\resources\views/auth/login.blade.php ENDPATH**/ ?>