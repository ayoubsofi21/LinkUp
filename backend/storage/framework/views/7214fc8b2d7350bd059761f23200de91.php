                    ...
                    <div class="preview-card float-a">
                        ...
                        <div class="p-5">
                            ...
                            <div class="mt-4 flex flex-wrap gap-1.5">
                                <?php $__currentLoopData = ['TypeScript','React','Go','PostgreSQL','Docker','K8s']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="w-full max-w-md mx-auto px-4 sm:px-0 py-8 lg:py-0">
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>"
                    ...
                    <div class="input-wrapper fade-up-delay-1">
                        <input
                            ...
                            autocomplete="name"
                            placeholder=" "
                            class="input-field <?php echo e($errors->has('name') ? 'has-error' : ''); ?>"
                        >
                    ...
                    <div class="input-wrapper fade-up-delay-2">
                        <input
                            ...
                            placeholder=" "
                            class="input-field <?php echo e($errors->has('email') ? 'has-error' : ''); ?>"
                        >
                    ...
                    <div class="fade-up-delay-3">
                        <div class="input-wrapper">
                            <input
                                ...
                                class="input-field pr-10 <?php echo e($errors->has('password') ? 'has-error' : ''); ?>"
                            >
                    ...
                    <div class="input-wrapper fade-up-delay-4">
                        <input
                            ...
                            autocomplete="new-password"
                            placeholder=" "
                            class="input-field pr-10 <?php echo e($errors->has('password_confirmation') ? 'has-error' : ''); ?>"
                        >
            ...
            <div class="mt-6 pb-8 text-center fade-up">
                ...
                <p class="mt-2 text-xs text-slate-700">
                    &copy; <?php echo e(date('Y')); ?> LinkUp. All rights reserved.
                </p>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\ENAA\Desktop\LinkUp\resources\views/auth/register.blade.php ENDPATH**/ ?>